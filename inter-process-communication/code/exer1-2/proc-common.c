...
//Changes the process name, as appears in ps or pstrea,
...
*has happened to the child processs.
*
*The child process may have:
*	*been terminated becase it received an unhandled signal (WIFSIGNALED)
